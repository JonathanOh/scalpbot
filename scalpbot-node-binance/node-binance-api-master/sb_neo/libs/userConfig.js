...
module.exports = function() {
	...
	var settings = {
		...
		purchaseAmount: 1,									// amount of coins to purchase/sell when market entry conditions are met
		...
		stageOneMinimumFillAmount: 0.2,			// minimum # of coins which must be bought/sold in Stage 1 to satisfy exchange's minimum requirements
		stageTwoMinimumFillAmount: 0.2,			// minimum # of coins which must be bought/sold in Stage 2 to satisfy exchange's minimum requirements
		...
		maxSatoshiJoinQuantity: 25,					// the maximum first-position quantity value in which the bot will join together instead of undercut
